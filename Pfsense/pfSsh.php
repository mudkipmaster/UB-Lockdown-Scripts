...
$config['filter']['rule'][] = array(
    ...
    'protocol' => 'tcp',
    'source' => array('any' => true),
    'destination' => array('network' => 'LAN_net', 'port' => '389'),
...
$config['filter']['rule'][] = array(
    ...
    'protocol' => 'tcp',
    'source' => array('any' => true),
    'destination' => array('network' => 'LAN_net', 'port' => '80'),
...
$config['filter']['rule'][] = array(
    ...
    'protocol' => 'tcp',
    'source' => array('any' => true),
    'destination' => array('network' => 'LAN_net', 'port' => '3306'),
...
$config['filter']['rule'][] = array(
    ...
    'protocol' => 'tcp',
    'source' => array('any' => true),
    'destination' => array('network' => 'LAN_net', 'port' => '5985'),
